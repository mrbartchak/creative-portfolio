...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen items-center justify-center p-4">
      {/* Hero Section */}
      <div className="bg-background shadow-lg rounded-lg p-6 max-w-5xl w-full h-56 mx-auto mb-8">
        ...
        <Link href="/contact" className="inline-block bg-foreground text-background rounded-lg px-4 py-2 hover:bg-gray-200 transition">
          Connect with me!
        </Link>
      </div>

      {/* Additional Cards Section */}
      <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 max-w-5xl w-full mx-auto">
        {/* Two Cards */}
        <div className="flex flex-col space-y-4 width-4/5 flex-grow">
          <div className="bg-background shadow-[0_0_32px_rgba(0,0,0,0.2)] rounded-lg p-6 h-full flex items-center justify-between">
            <div>
              ...
              <p className="text-lg text-gray-700">Information Technology Analyst at</p>
              <p className="text-lg text-gray-700">Sumitomo Mitsui Banking Corporation</p>
            </div>
        ...
        {/* Vertical Card */}
        <div className="bg-background shadow-lg rounded-lg p-6 w-full md:w-1/5 flex-grow">
