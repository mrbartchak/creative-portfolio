...
const Sidebar = () => {
    return (
      <div className="flex flex-col lg:justify-start p-4 pt-24 lg:pl-12 w-104 bg-transparent">
        <div className="flex lg:flex-col flex-row">
          <Image src="/profile.jpg" alt="Profile" className="rounded-full lg:w-64 lg:h-64 w-32 h-32 p-4 mb-4 drop-shadow-2xl" width={3021} height={3021} quality={100} />
          <div>
        ...
        <nav className="flex lg:flex-col flex-row mt-8 lg:space-x-0 space-x-2">
